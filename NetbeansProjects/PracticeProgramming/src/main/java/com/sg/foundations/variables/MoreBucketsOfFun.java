...
public class MoreBucketsOfFun {
    public static void main(String[] args) {
        ...
        butterflies--;
        // the -- operator is used to decrement the butterflies variable by 1.
        System.out.println("Now there are only " + butterflies + " butterflies left.");
        System.out.println("But there are still " + bugs + " bugs left...");
        //Number of bugs does not change since post decrement (i--) is used, meaning 
        //butterflies is used first by Bugs then incremented afterwards.
